...
namespace WebResurection.Controllers
{
    public class SkillController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Name,Description,Level")] Skill skill)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Name,Description,Level")] Skill skill)
        {
            if (ModelState.IsValid)
            {
