...
namespace WebResurection.Controllers
{
    public class StatController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Name,Description,Value,Modifier")] Stat stat)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Name,Description,Value,Modifier")] Stat stat)
        {
            if (ModelState.IsValid)
            {
